...
TTestResult_Group Test_TMD5()
{
...

	{
		...
		result.Add( { { {"Multi string"}, "57edf4a22be3c955ac49da2e2107b67a"}, test.Get_MD5() } );
	}
...

	{
		...
		result.Add( { { {"Multi step 1"}, "d41d8cd98f00b204e9800998ecf8427e"}, test.Get_MD5() } );	//  ""

		test.Update( "a" );

		result.Add( { { {"Multi step 2"}, "0cc175b9c0f1b6a831c399e269772661"}, test.Get_MD5() } );	//  "a"

		test.Update( "bc" );

		result.Add( { { {"Multi step 3"}, "900150983cd24fb0d6963f7d28e17f72"}, test.Get_MD5() } );	//  "abc"
