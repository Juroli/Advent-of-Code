...
const int S11 = 7;						//	#define S11 7
const int S12 = 12;						//	#define S12 12
const int S13 = 17;						//	#define S13 17
const int S14 = 22;						//	#define S14 22
const int S21 = 5;						//	#define S21 5
const int S22 = 9;						//	#define S22 9
const int S23 = 14;						//	#define S23 14
const int S24 = 20;						//	#define S24 20
const int S31 = 4;						//	#define S31 4
const int S32 = 11;						//	#define S32 11
const int S33 = 16;						//	#define S33 16
const int S34 = 23;						//	#define S34 23
const int S41 = 6;						//	#define S41 6
const int S42 = 10;						//	#define S42 10
const int S43 = 15;						//	#define S43 15
const int S44 = 21;						//	#define S44 21

void MD5Transform( std::uint32_t[4], unsigned char[64] );
void Encode( unsigned char*, std::uint32_t*, unsigned int );
void Decode( std::uint32_t*, unsigned char*, unsigned int );
...
*/
static void MD5Transform( std::uint32_t state[4], unsigned char block[64] )
{
...
a multiple of 4.
*/
void Encode( unsigned char* output, std::uint32_t* input, unsigned int len )
{
	unsigned int i, j;
...
a multiple of 4.
*/
void Decode( std::uint32_t* output, unsigned char* input, unsigned int len )
{
	unsigned int i, j;
